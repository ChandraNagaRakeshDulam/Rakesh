          ...
          <ul className={menuOpen ? 'show' : ''}>
            ...
            <li className="dropdown">
              ...
              <div className="dropdown-content">
                <a href="{`${process.env.PUBLIC_URL}/Resume_Rakesh.pdf`}" target="_blank" rel="noopener noreferrer" onClick={toggleMenu}>View</a>
                <a href="{`${process.env.PUBLIC_URL}/Resume_Rakesh.pdf`}" download onClick={toggleMenu}>Download</a>
              </div>
            </li>
